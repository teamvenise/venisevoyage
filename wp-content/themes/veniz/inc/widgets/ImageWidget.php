 ...
 * @see WP_Widget
 */
class ImageWidget extends WP_Widget_Media {
	...
	public function __construct() {
		parent::__construct( 'ImageWidget', __( 'Image Custom' ), array(
			'description' => __( 'Displays an image custom.' ),
			'mime_type'   => 'image',
		) );
...
add_action( 'widgets_init', create_function( '', 'return register_widget( "ImageWidget" );' ) );
