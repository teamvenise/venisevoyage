  ...
  private static function _load($pid) {
    ...
    if($p->post_type == "transfert"){
   	   ...
   	   //traitement des donn�es
            ...
            $element->icone_start = get_field('icone_start', intval($pid));
            $element->icone_end = get_field('icone_end', intval($pid));
            $element->type = get_field_object('type', intval($pid));
            $element->lien_reserver = get_field('lien_reserver', intval($pid));
