...
<input type="checkbox" name="wp_datepicker_months" value="1" <?php checked($wp_datepicker_months); ?> /> <small><?php _e( 'Default: Short names will appear in dropdown and navigation. e.g. Sep or September?', 'wp-datepicker' ); ?></small>
</div>
